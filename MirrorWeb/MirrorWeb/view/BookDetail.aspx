<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ResAdmin.Master" AutoEventWireup="true" CodeBehind="BookDetail.aspx.cs" Inherits="DRMS.MirrorWeb.view.BookDetail" %>
...
<link type="text/css" rel="stylesheet" href="../css/BookDetail.css" />
    ...
    <script type="text/javascript">
        ...
        //收藏资源
        function favoriteData(doi, type, name) {
            $.ajax({
                type: "GET",
                cache: false,
                url: "/ajax/FavoriteData.ashx",
                data: "doi=" + doi + "&type=" + type + "&name=" + encodeURIComponent(name),
                                ...
                                <div id="haveResult" runat="server" visible="false">
                                    <div class="singleBook">
                                        ...
                                        <div class="sgbMain">
                                            ...
                                            <div class="sgbmr">
                                                <ul class="summary">
                                                    <asp:Literal ID="lt_summary" runat="server" EnableViewState="false"></asp:Literal>
                                                </ul>
                                                <div class="book-price">
                                                    <asp:Literal ID="lt_price" runat="server" EnableViewState="false"></asp:Literal>
                                                </div>
                                                <div class="clear">
                                                </div>
                                            </div>
