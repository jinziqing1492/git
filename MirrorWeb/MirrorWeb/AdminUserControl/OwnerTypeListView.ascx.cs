...
{
    public partial class OwnerTypeListView : BasePage.AdminBaseControl
    {
        #region 字段,属性
        /// <summary>
        /// 页码
        ...
        /// 自有资源类型操作类对象
        /// </summary>
        private OwnerResourceType bll = new OwnerResourceType();
        #endregion
        ...
        /// 绑定自有资源列表
        /// </summary>
        private void BindOwnerTypeList()
        {
            IList<OwnerResourceTypeInfo> OwnerList = bll.GetList(SqlQueryCondition, PageNo, PageSize, out recordCount, true);
        ...
        private void SetSqlQueryCondition()
        {
            ...
            {
                this.SqlQueryCondition = " order by sys_fld_adddate";
            }
            else
            {
        ...
        {
            string content = string.Format("为您检索到 {0} 个分类，共 {1} 页，当前是第 {2} 页。", this.RecordCount, this.PageCount, this.PageNo);
