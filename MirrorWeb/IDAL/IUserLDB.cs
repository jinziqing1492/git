...
namespace DRMS.IDAL
{
    public interface IUserLDB
    {
        /// <summary>
        /// 添加用户包库
        /// </summary>
        /// <param name="item">用户包库实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(UserLDBInfo Item);

        /// <summary>
        /// 删除用户包库
        /// </summary>
        /// <param name="id">用户包库的SYS_FLD_DOI</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        List<UserLDBInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
