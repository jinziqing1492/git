...
namespace DRMS.IDAL
{
    public interface IFavoriteData
    {
        ...
        /// 添加收藏信息
        /// </summary>
        /// <param name="item">收藏信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(FavoriteDataInfo Item);

        /// <summary>
        /// 删除收藏信息
        /// </summary>
        /// <param name="id">收藏信息的主键</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        /// <param name="item">收藏信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(FavoriteDataInfo item);
        ...
        FavoriteDataInfo GetItem(string id);
        ...
        List<FavoriteDataInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
