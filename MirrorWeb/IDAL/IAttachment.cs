...
namespace DRMS.IDAL
{
    public interface IAttachment
    {
        ...
        bool Add(AttachmentInfo Item);

        /// <summary>
        /// 删除附件
        /// </summary>
        /// <param name="id">附件的SYS_FLD_DOI</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        /// <param name="item">附件实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(AttachmentInfo item);
        ...
        AttachmentInfo GetItem(string id);
        ...
        List<AttachmentInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
