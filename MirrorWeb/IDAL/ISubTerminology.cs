...
namespace DRMS.IDAL
{
    public interface ISubTerminology
    {
        /// <summary>
        /// 添加
        /// </summary>
        /// <param name="item">词语实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(SubterminologyInfo Item);

        /// <summary>
        /// 删除
        /// </summary>
        /// <param name="id">词语的SYS_FLD_DOI</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        /// <param name="item">词语实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(SubterminologyInfo item);
        ...
        SubterminologyInfo GetItem(string id);
        ...
        List<SubterminologyInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
