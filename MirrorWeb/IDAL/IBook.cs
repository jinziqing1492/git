...
namespace DRMS.IDAL
{
    public interface IBook
    {
        ...
        /// 添加图书
        /// </summary>
        /// <param name="item">图书实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(BookInfo Item);
        ...
        List<BookInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
        ...
        /// 导出数据用 根据字段列表导出数据
        /// </summary>
        /// <param name="Fields">字段列表（就是字段 没有 中文名的）</param>
        /// <param name="tableName">表名</param>
        /// <param name="sqlWhere">where后面的条件</param>
        /// <param name="pageNo"></param>
        /// <param name="pageCount"></param>
        /// <param name="recordCount"></param>
        /// <returns></returns>
        List<List<string>> GetDataByFieldList(List<string> Fields, string tableName, string sqlWhere, int pageNo, int pageCount, out int recordCount);
    }
}
