...
namespace DRMS.IDAL
{
    public interface INewsPaperInfo
    {
        /// <summary>
        /// 添加报纸信息
        /// </summary>
        /// <param name="item">报纸实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(NewsPaperInfo Item);

        /// <summary>
        /// 删除报纸信息
        /// </summary>
        /// <param name="id">报纸的主键</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        /// <param name="item">报纸实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(NewsPaperInfo item);
        ...
        NewsPaperInfo GetItem(string id);
        ...
        List<NewsPaperInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
