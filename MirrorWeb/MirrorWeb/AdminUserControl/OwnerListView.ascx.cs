...
{
    public partial class OwnerListView :BasePage.AdminBaseControl
    {
        #region 字段,属性
        /// <summary>
        /// 页码
        ...
        /// 自有资源操作类对象
        /// </summary>
        private Journal bll = new Journal("owner");

        /// <summary>
        /// 自有资源分类操作对象
        /// </summary>
        private OwnerResourceType typeBll = new OwnerResourceType();
        #endregion
        ...
        /// 绑定自有资源列表
        /// </summary>
        private void BindOwnerList()
        {
            IList<JournalInfo> OwnerList = bll.GetList(SqlQueryCondition, PageNo, PageSize, out recordCount, true);
            ...
            this.repEntryList.DataSource = OwnerList;
            this.repEntryList.DataBind();
        }
        ...
        private void SetSqlQueryCondition()
        {
            ...
            {
                this.SqlQueryCondition = " order by cname";
            }
            else
            {
        ...
        protected string GetTypeName(object input)
        {
            if (input != null)
            {
                string type = input.ToString();
                OwnerResourceTypeInfo info = typeBll.GetItemByBaseID(type);
                if (info != null)
                {
                    return info.NAME;
                }
