...
namespace DRMS.IDAL
{
    public interface IYearBookYearInfo
    {
        /// <summary>
        /// 添加年鉴年
        /// </summary>
        /// <param name="item">年鉴年实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(YearBookYearInfo Item);

        /// <summary>
        /// 删除年鉴年
        /// </summary>
        /// <param name="id">年鉴年的SYS_FLD_DOI</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        /// <param name="item">年鉴年实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(YearBookYearInfo item);
        ...
        YearBookYearInfo GetItem(string id);
        ...
        List<YearBookYearInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
