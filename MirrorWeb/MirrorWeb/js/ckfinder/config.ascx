...
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        //rabtor 2012-10 修改
        //if (CCMS.Common.AdminManager.IsAdmin())
        //    return true;
        //else
        //    return false;
        return true;
	...
	public override void SetConfig()
	{
		...
		LicenseName = "rabtor";
		LicenseKey = "PYDE7425G6HB2XX43X1YEW7WK6GPW3MHFR";

		// The base URL used to reach files in CKFinder through the browser.
		//BaseUrl = "/ckfinder/userfiles/";//默认
        BaseUrl = "~/upload/ckfinder/";//上传目录，rabtor 2012-10 修改
		...
		// feature.
        Images.MaxWidth = 4000;//Images.MaxWidth = 1600;
        Images.MaxHeight = 4000;//Images.MaxHeight = 1200;
		Images.Quality = 80;
