...
namespace DRMS.BLL
{
    ...
    {
        private static readonly IResourceType Dal = SelectData.CreateResourceType();
        ...
        public const string PARM_REMARK = "REMARK";
        #endregion
        /// <summary>
        /// 添加
        /// <summary>
        ...
        /// <param name='id'></param>
        /// <returns></returns>
        public ResourceTypeInfo GetItem(string id)
        {
        ...
        /// <returns></returns>
        public IList<ResourceTypeInfo> GetList(string strwhere, int pageno, int pagecount, out int recordcount, bool isRed = false)
        {
        ...
        /// <returns></returns>
        public IList<ResourceTypeInfo> GetList(string strwhere, int pageno, int pagecount, out int recordcount, string[] fields, bool isRed = false)
        {
