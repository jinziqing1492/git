...
namespace DRMS.IDAL
{
    public interface IThesis
    {
        ...
        /// 添加学位论文
        /// </summary>
        /// <param name="item">学位论文实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(ThesisInfo Item);
        ...
        List<ThesisInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
