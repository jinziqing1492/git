...
namespace DRMS.IDAL
{
    public interface IJournalArticle
    {
        /// <summary>
        /// 设置表名
        /// </summary>
        ...
        /// 添加期刊文章实体
        /// </summary>
        /// <param name="item">期刊文章实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(JournalArticleInfo Item);
        ...
        /// <param name="item">期刊文章实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(JournalArticleInfo item);
        ...
        JournalArticleInfo GetItem(string id);
        ...
        List<JournalArticleInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
