...
namespace DRMS.IDAL
{
    public interface IOriginalData
    {
        ...
        /// 添加原始资料库
        /// </summary>
        /// <param name="item">原始资料库实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(OriginalDataInfo Item);

        /// <summary>
        /// 删除原始资料库
        /// </summary>
        /// <param name="id">原始资料库的SYS_FLD_DOI</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        /// <param name="item">原始资料库实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(OriginalDataInfo item);
        ...
        OriginalDataInfo GetItem(string id);
        ...
        List<OriginalDataInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
