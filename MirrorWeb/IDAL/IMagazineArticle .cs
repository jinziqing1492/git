...
namespace DRMS.IDAL
{
    public interface IMagazineArticle
    {
        /// <summary>
        /// 添加杂志文章
        /// </summary>
        /// <param name="item">杂志文章实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(MagazineArticleInfo Item);
        ...
        /// <param name="item">杂志文章实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(MagazineArticleInfo item);
        ...
        MagazineArticleInfo GetItem(string id);
        ...
        List<MagazineArticleInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
