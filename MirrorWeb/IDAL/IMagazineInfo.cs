...
namespace DRMS.IDAL
{
    public interface IMagazineInfo
    {
        /// <summary>
        /// 添加杂志信息
        /// </summary>
        /// <param name="item">杂志信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(MagazineInfo Item);

        /// <summary>
        /// 删除杂志信息
        /// </summary>
        /// <param name="id">杂志信息的主键</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        MagazineInfo GetItem(string id);
        ...
        List<MagazineInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
