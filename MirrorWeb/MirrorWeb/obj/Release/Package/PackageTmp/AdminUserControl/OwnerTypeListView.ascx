<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OwnerTypeListView.ascx.cs" Inherits="DRMS.MirrorWeb.AdminUserControl.OwnerTypeListView" %>
        ...
        <asp:Repeater ID="repEntryList" OnItemCommand="RepeaterItemCommand" runat="server">
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                        <%#ReplaceRed( Eval("DESCRIPT")) %>
                    </td>
                    <td>
                        <%#Eval("SYS_FLD_ADDDATE") %>
                    </td>
                    <td>
                        <a href="OwnerTypeItem.aspx?doi=<%#RemoveRed(Eval("SYS_FLD_DOI")) %>">
