...
<ul id="main-nav">
    ...
    <li><a href="#" class="nav-top-item">贵飞资源管理</a>
        <ul>
            <li><a href="../Admin/ResourceTypeItem.aspx">添加资源分类</a></li>
            <li><a href="../Admin/ResourceTypeList.aspx">资源分类列表</a></li>
            <li><a href="../Admin/ResourceDataItem.aspx">添加资源</a></li>
            <li><a href="../Admin/ResourceDataList.aspx">资源列表</a></li>
        </ul>
    </li>
