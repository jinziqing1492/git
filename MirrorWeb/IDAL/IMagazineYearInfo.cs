...
namespace DRMS.IDAL
{
    public interface IMagazineYearInfo
    {
        /// <summary>
        /// 添加杂志年信息
        /// </summary>
        /// <param name="item">杂志年信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(MagazineYearInfo Item);
        ...
        /// <param name="item">杂志年信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(MagazineYearInfo item);
        ...
        MagazineYearInfo GetItem(string id);
        ...
        List<MagazineYearInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
