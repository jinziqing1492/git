...
(function () {
    ...
    j.add('resize', {
        ...
        var p = function () {
            var t = this,
            u = function () {
                if (q.instances[t.name]) q.instances[t.name].destroy();
                var y = t.config,
                z = {};
            ...
            function (y) {
                if (y.data.name == 'source' && t.mode == 'source') q.markControlRestore(t);
            });
        ...
        j.add('scayt', {
            ...
            init: function (t) {
                ...
                if (t.contextMenu && t.addMenuItems) t.contextMenu.addListener(function (E, F) {
                    ...
                    typeof O != 'number' && (O = 5); !O && (O = K.length);
...
//                            t.push('" onclick="CKEDITOR.tools.callFunction(' + K + ')">', '<span>&#9650;</span>', '</a>');
    ...
    j.add('dialogui'); (function () {
        ...
        k.dialog.checkbox.prototype = e.extend(new k.dialog.uiElement(), {
            ...
            eventProcessors: {
                onChange: function (u, v) {
                    if (!c || b.version > 8) return r.onChange.apply(this, arguments);
                    else {
                        u.on('load',
                        function () {
    ...
    a.themes.add('default', (function () {
        ...
        return {
            build: function (o, p) {
                ...
                var D = h.createFromHtml(['<span id="cke_', q, '" class="', o.skinClass, ' ', o.id, ' cke_editor_', q, '" dir="', o.lang.dir, '" title="', b.gecko ? ' ' : '', '" lang="', o.langCode, '"' + (b.webkit ? ' tabindex="' + x + '"' : '') + ' role="application"' + ' aria-labelledby="cke_', q, '_arialbl"' + (y ? ' style="' + y + '"' : '') + '>' + '<span id="cke_', q, '_arialbl" class="cke_voice_label">' + o.lang.editor + '</span>' + '<span class="', b.cssClass, '" role="presentation"><span class="cke_wrapper cke_', o.lang.dir, '" role="presentation"><table class="cke_editor" id="cke_editor_tableid" border="0" cellspacing="0" cellpadding="0" role="presentation"><tbody><tr', t ? '' : ' style="display:none"', ' role="presentation"><td id="cke_top_', q, '" class="cke_top" role="presentation">', t, '</td></tr><tr', u ? '' : ' style="display:none"', ' role="presentation"><td id="cke_contents_', q, '" class="cke_contents" style="height:', w, '" role="presentation">', u, '</td></tr><tr', v ? '' : ' style="display:none"', ' role="presentation"><td id="cke_bottom_', q, '" class="cke_bottom" role="presentation">', v, '</td></tr></tbody></table>' + C + '</span>' + '</span>' + '</span>'].join(''));
