...
namespace DRMS.IDAL
{
    public interface INewsPaperYearInfo
    {
        /// <summary>
        /// 添加报纸年信息
        /// </summary>
        /// <param name="item">报纸年信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(NewsPaperYearInfo Item);
        ...
        /// <param name="item">报纸年信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(NewsPaperYearInfo item);
        ...
        NewsPaperYearInfo GetItem(string id);
        ...
        List<NewsPaperYearInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
