...
namespace DRMS.IDAL
{
    public interface IStdData
    {
        ...
        /// 添加存放标准数据的数据表
        /// </summary>
        /// <param name="item">存放标准数据的数据表实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(StdDataInfo Item);

        /// <summary>
        /// 删除存放标准数据的数据表
        /// </summary>
        /// <param name="id">存放标准数据的数据表的SYS_FLD_DOI</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        List<StdDataInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
