...
namespace DRMS.IDAL
{
    public interface IJournalYearInfo
    {
        /// <summary>
        /// 设置表名
        /// </summary>
        ...
        /// 添加期刊年信息
        /// </summary>
        /// <param name="item">期刊年信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(JournalYearInfo Item);
        ...
        /// <param name="item">期刊年信息实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(JournalYearInfo item);
        ...
        JournalYearInfo GetItem(string id);
        ...
        List<JournalYearInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
