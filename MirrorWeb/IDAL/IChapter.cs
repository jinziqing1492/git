...
namespace DRMS.IDAL
{
    public interface IChapter
    {
        ...
        /// 添加
        /// </summary>
        /// <param name="item">图书章节实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(ChapterInfo Item);
        ...
        List<ChapterInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
