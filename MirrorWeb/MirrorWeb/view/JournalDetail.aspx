<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ResAdmin.Master" AutoEventWireup="true" CodeBehind="JournalDetail.aspx.cs" Inherits="DRMS.MirrorWeb.view.JournalDetail" %>
          ...
          <%--                          <div class="singleDetail">
                               ...
                               <%--     <div class="singleDetail">
                                        <h2>
                                            文章列表</h2>
                                        <div class="sm">--%>
                                            <asp:Literal ID="ltl_ArticleList" runat="server" EnableViewState="false"></asp:Literal>
                                     <%--   </div>
                                    </div>--%>
                                   <%--   <div class="singleDetail">
                                         <div class="sm">--%>
