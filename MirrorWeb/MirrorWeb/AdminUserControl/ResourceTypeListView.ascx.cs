...
{
    public partial class ResourceTypeListView :BasePage.AdminBaseControl
    {
        #region 字段,属性
        /// <summary>
        /// 页码
                ...
                case "Delete":
                    {
                        ...
                        if (issuccess)
                        {
                            ...
                            BllLogObj.Add(DataBaseType.RESOURCETYPE, LogType.DELETE, doi, doi, "删除资源类型");
        ...
        {
            ResourceType bll = new ResourceType();
            IList<ResourceTypeInfo> typeList = bll.GetList(SqlQueryCondition, PageNo, PageSize, out recordCount, true);
