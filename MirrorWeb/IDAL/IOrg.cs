...
namespace DRMS.IDAL
{
    public interface IOrg
    {
        ...
        /// 添加机构
        /// </summary>
        /// <param name="item">机构实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(OrgInfo Item);
        ...
        List<OrgInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
