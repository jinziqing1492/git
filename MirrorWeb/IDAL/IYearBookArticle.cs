...
namespace DRMS.IDAL
{
    public interface IYearBookArticle
    {
        /// <summary>
        /// 添加年鉴文章
        /// </summary>
        /// <param name="item">年鉴文章实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(YearBookArticleInfo Item);
        ...
        /// <param name="item">年鉴文章实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Update(YearBookArticleInfo item);
        ...
        YearBookArticleInfo GetItem(string id);
        ...
        List<YearBookArticleInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
        ...
        /// 审核状态
        /// </summary>
        /// <param name="id">图书章节的SYS_FLD_DOI</param>
        /// <param name="state">0未审核 -1审核通过</param>
        /// <returns></returns>
