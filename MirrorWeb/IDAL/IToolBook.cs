...
namespace DRMS.IDAL
{
    public interface IToolBook
    {
        /// <summary>
        /// 添加工具书
        /// </summary>
        /// <param name="item">工具图书实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(ToolBookInfo Item);

        /// <summary>
        /// 删除工具书
        /// </summary>
        /// <param name="id">工具图书的SYS_FLD_DOI</param>
        /// <returns>true 成功； false 失败</returns>
        ...
        ToolBookInfo GetItem(string id);
        ...
        List<ToolBookInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
