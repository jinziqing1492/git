...
namespace DRMS.IDAL
{
    public interface IAudio
    {
        ...
        /// 添加音频
        /// </summary>
        /// <param name="item">音频实体</param>
        /// <returns>true 成功； false 失败</returns>
        bool Add(AudioInfo Item);
        ...
        List<AudioInfo> GetList(string sqlWhere, int pageNo, int pageCount, out int recordCount, bool IsAll);
