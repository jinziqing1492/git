        ...
        private void BindData(string doi, string type)
        {
            ...
            else
            {
                ...
                if (mydbtype == DataBaseType.BOOKTDATA)
                {
                    ...
                    {
                        sb.AppendFormat("<li><span class='sAuthor'>【图书作者】</span>{0}</li>", author);
                    }
                    else
                    {
                        sb.AppendFormat("<li><span class='sAuthor'>【图书作者】</span>{0}</li>", Utility.Utility.ReplaceBeginStr(info.Author));
                    }
